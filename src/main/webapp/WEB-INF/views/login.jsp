...
<!-- -----------------------------------------------查询已发布的考试-------------------------------------------------------------------------------------- -->
          ...
          <div  style="background-image: url('images/huise.jpg'); margin: 0 5.8%;height: 80%" id="wdks1" hidden="true">
             <br>
         <br>
         <br>
         <br>
              ...
              <br>
               <br>
                <br>
                 ...
                 <div align="center">
                <button type="button" class="btn btn-danger" id="ksks">开始考试</button> 
                 </div>
...
<div class="panel-heading" ><span>现在是第</span><i class="content_lit" id="sjxztm" style="font-size: 30px;color: red;">0</i><span>题</span></span><span>共</span><i class="content_lit" id="sjtmzs" style="font-size: 30px;color: red;"></i><span>题</span></span></div>
            ...
            <!-- -----------------------------------------班级排名页面-------------------------------------------------------------- -->
             <div id="bjpm1"  hidden="true" style="margin:0 5.8%;"  >
